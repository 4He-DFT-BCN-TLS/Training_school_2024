...
Real (Kind=8) :: V_Na2_sspg              ! selec='Na2_sspg'    Singlet Sigma plus g  (3s-3s) Olivier Dulieu data
Real (Kind=8) :: V_Na2_tspu              ! selec='Na2_tspu'
...
If(xx.le.RCs(1))Then
  V_Cs_ssg=Bb*Exp(Aa*xx)
  Return
Endif
Endif

If(xx.ge.RCs(22))Then
  V_Cs_ssg=c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.le.RCstsu(1))Then
  V_Cs_tsu=Bb*Exp(Aa*xx)
  Return
Endif
Endif

If(xx.ge.RCstsu(22))Then
  V_Cs_tsu=c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.le.RCssgps(1))Then
  V_Cs_ssg_ps=Bb*Exp(Aa*xx)
  Return
Endif
Endif

If(xx.ge.RCssgps(22))Then
  V_Cs_ssg_ps=c3/xx**3+c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.le.RCssups(1))Then
  V_Cs_ssu_ps=Bb*Exp(Aa*xx)
  Return
Endif
Endif

If(xx.ge.RCssups(22))Then
   V_Cs_ssu_ps=c3/xx**3+c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.le.RCspgps(1))Then
  V_Cs_spg_ps=Bb*Exp(Aa*xx)
  Return
Endif
Endif

If(xx.ge.RCspgps(22))Then
  V_Cs_spg_ps=c3/xx**3+c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.ge.RCspups(22))Then
   V_Cs_spu_ps=c3/xx**3+c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.le.RCtpgps(1))Then
  V_Cs_tpg_ps=Bb*Exp(Aa*xx)
  Return
Endif
Endif

If(xx.ge.RCtpgps(22))Then
   V_Cs_tpg_ps=c3/xx**3+c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.le.RCtpups(1))Then
   V_Cs_tpu_ps=Bb*Exp(Aa*xx)
  Return
Endif
Endif

If(xx.ge.RCtpups(22))Then
  V_Cs_tpu_ps=c3/xx**3+c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.le.RCtsgps(1))Then
    V_Cs_tsg_ps=Bb*Exp(Aa*xx)
  Return
Endif
Endif

If(xx.ge.RCtsgps(22))Then
  V_Cs_tsg_ps=c3/xx**3+c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
If(xx.ge.RCtsups(22))Then
  V_Cs_tsu_ps=c3/xx**3+c6/xx**6+c8/xx**8+limdiso
  Return
Endif
...
Implicit Real*8(A-H,O-Z)
!!!Energy in K and R in \AA
Common/Param_Spline2_Cs_RO_sspg/RCtsups(N),ECtsups(N),roctsups,ECcsmaxtsups,rfctsups
Data RCtsups/                                                                        &
...
If(xx.le.roctsups)Then
  V_Cs_RO_sspg=ECcsmaxtsups
  Return
Else
If(xx.le.RCtsups(1))Then
   V_Cs_RO_sspg=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_sspg= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Implicit Real*8(A-H,O-Z)
!!!Energy in K and R in \AA
Common/Param_Spline2_Cs_RO_sspu/RCtsups(N),ECtsups(N),roctsups,ECcsmaxtsups,rfctsups
Data RCtsups/                                                                        &
...
If(xx.le.roctsups)Then
  V_Cs_RO_sspu=ECcsmaxtsups
  Return
else
If(xx.le.RCtsups(1))Then
   V_Cs_RO_sspu=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_sspu= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_spig= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Implicit Real*8(A-H,O-Z)
!!!Energy in K and R in \AA
Common/Param_Spline2_Cs_RO_spiu/RCtsups(N),ECtsups(N),roctsups,ECcsmaxtsups,rfctsups
Data RCtsups/                                                                        &
  0.33867340D+01,  0.34925694D+01,  0.35984049D+01,  0.37042403D+01,  0.38100758D+01, &
 0.39159112D+01,  0.40217466D+01,  0.41275821D+01,  0.42334175D+01,  0.43392529D+01, &
 0.44450884D+01,  0.45509238D+01,  0.46567593D+01,  0.47625947D+01,  0.48684301D+01, &
...
If(xx.le.roctsups)Then
  V_Cs_RO_spiu=ECcsmaxtsups
  Return
else
If(xx.le.RCtsups(1))Then
   V_Cs_RO_spiu=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_spiu= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_sdg= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tspg= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tspu= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tpig= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tdg= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tdu= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_sdu= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tpiu= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
If(xx.le.RCtsups(1))Then
   V_Cs_RO_sspg_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_sspg_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
If(xx.le.RCtsups(1))Then
   V_Cs_RO_tspu_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tspu_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
If(xx.le.RCtsups(1))Then
   V_Cs_RO_sspu_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_sspu_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Else
If(xx.le.RCtsups(1))Then
   V_Cs_RO_spig_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_spig_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
If(xx.le.RCtsups(1))Then
   V_Cs_RO_spiu_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_spiu_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
If(xx.le.RCtsups(1))Then
   V_Cs_RO_tspg_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tspg_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Else
If(xx.le.RCtsups(1))Then
   V_Cs_RO_tpig_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tpig_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
If(xx.le.RCtsups(1))Then
   V_Cs_RO_tpiu_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tpiu_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
If(xx.le.RCtsups(1))Then
   V_Cs_RO_sspg_plus_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_sspg_plus_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
If(xx.le.RCtsups(1))Then
   V_Cs_RO_tspu_plus_plus=Bb*Exp(Aa*xx)
  Return
Endif
Endif
...
Call spline2(RCtsups,ECtsups,a,b,c,d,0,0,N)
Call Findi2(RCtsups,xx,N,ix)
V_Cs_RO_tspu_plus_plus= a(ix) + (b(ix) + xx*(c(ix) + xx*d(ix)))*xx
Return 
End
...
Data ECtsups/                                                                        &
 0.47917414D+05,  0.41789199D+05,  0.35647202D+05,  0.29826232D+05,  0.24425668D+05, &
 0.19461238D+05,  0.14927545D+05,  0.10820403D+05,  0.71413498D+04,  0.38942295D+04, &
 0.10794147D+04, -0.13107784D+04, -0.32939503D+04, -0.48968414D+04, -0.61528827D+04, &
-0.70992469D+04, -0.77741565D+04, -0.82148730D+04, -0.84564468D+04, -0.85310522D+04, &
-0.84677668D+04, -0.82925725D+04, -0.80284524D+04, -0.76955740D+04, -0.73115012D+04, &
-0.68913998D+04, -0.64482690D+04, -0.59931598D+04, -0.55353713D+04, -0.50826374D+04, &
-0.46412756D+04, -0.42163429D+04, -0.38117538D+04, -0.34303957D+04, -0.30742392D+04, &
-0.27444367D+04, -0.24414299D+04, -0.21650540D+04, -0.19146405D+04, -0.16891235D+04, &
-0.14871420D+04, -0.13071270D+04, -0.11473886D+04, -0.10061845D+04, -0.88177835D+03, &
-0.77247963D+03, -0.67668390D+03, -0.59288577D+03, -0.51969895D+03, -0.45585692D+03, &
-0.40021821D+03, -0.35175567D+03, -0.30955814D+03, -0.27281974D+03, -0.24082711D+03, &
-0.21295933D+03, -0.18866807D+03, -0.16747650D+03, -0.14897183D+03, -0.13279418D+03, &
-0.11863369D+03, -0.10621797D+03, -0.95314550D+02, -0.85723039D+02, -0.77271778D+02, &
-0.69805214D+02, -0.63201865D+02, -0.57344967D+02, -0.52141068D+02, -0.47506339D+02, &
-0.43370070D+02, -0.39669809D+02, -0.36353772D+02, -0.33375283D+02, -0.30694521D+02, &
-0.28273453D+02, -0.26086817D+02, -0.24106532D+02, -0.22306240D+02, -0.20672362D+02, &
-0.19181227D+02, -0.17821339D+02, -0.16576080D+02, -0.15437760D+02, -0.14391426D+02, &
